...
training_df = pd.get_dummies(training_df, columns=["DayOfWeek"])
...
training_df.drop(["Open", "Customers", "StateHoliday", "SchoolHoliday"], axis=1, inplace=True)
...
test_df.drop(["Open", "StateHoliday", "SchoolHoliday"], axis=1, inplace=True)
...
submission.to_csv("predictions/linearregression2.csv", index=False)
