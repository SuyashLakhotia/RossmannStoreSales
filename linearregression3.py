...
training_df.drop(["Open", "Customers", "SchoolHoliday"], axis=1, inplace=True)
...
test_df.drop(["Open", "SchoolHoliday"], axis=1, inplace=True)
...
submission.to_csv("predictions/linearregression3.csv", index=False)
